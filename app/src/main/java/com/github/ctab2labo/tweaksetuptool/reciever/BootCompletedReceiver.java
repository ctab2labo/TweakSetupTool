...
public class BootCompletedReceiver extends BroadcastReceiver {
    private final int INTENT_REQUEST_SERVICE = 3;
    ...
    public void onReceive(Context context, Intent intent) {
        if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) { // インテントのフィルター
            ...
            PendingIntent pendingIntent = PendingIntent.getService(context, INTENT_REQUEST_SERVICE, intent1, PendingIntent.FLAG_UPDATE_CURRENT);
            // 12時間周期の定期処理をセット
